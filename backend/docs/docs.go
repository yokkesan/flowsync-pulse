...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/company.CreateResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/task.ListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "auth.CurrentUserResponse": {
            ...
            "properties": {
                "company": {
                    "$ref": "#/definitions/auth.CurrentUserCompany"
                },
                "user": {
                    "$ref": "#/definitions/auth.CurrentUserCompanyMember"
                }
            }
        },
        "auth.ErrorResponse": {
        ...
        "auth.LoginResponse": {
            ...
            "properties": {
                ...
                "company": {
                    "$ref": "#/definitions/auth.LoginCompany"
                },
                "expires_in": {
                    "type": "integer"
                },
        ...
        "user.ListResponse": {
            ...
            "properties": {
                "users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/user.ListMemberResponse"
                    }
                }
            }
        },
